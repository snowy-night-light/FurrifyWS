...
@Component
@Slf4j
class Azw3GeneratorBookFile extends EPubGeneratorBookFile {

    public Azw3GeneratorBookFile(
    ...
    protected File generateFile(BookDTO bookDto, List<ChapterData> chapters, ws.furrify.worker.dto.worker.book.BookFileUserWorkerTaskDTO task) {
        log.debug("Delegating to EPUB generator to create temporary file for AZW3 conversion.");
